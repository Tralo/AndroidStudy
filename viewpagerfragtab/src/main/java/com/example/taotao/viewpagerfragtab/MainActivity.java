package com.example.taotao.viewpagerfragtab;
...
import com.example.taotao.viewpagerfragtab.adapter.FragmentViewPagerAdapter;
import com.example.taotao.viewpagerfragtab.frag.FragmentHuodong;
import com.example.taotao.viewpagerfragtab.frag.FragmentMain;
import com.example.taotao.viewpagerfragtab.frag.FragmentMy;
import com.example.taotao.viewpagerfragtab.frag.FragmentShequ;
import com.example.taotao.viewpagerfragtab.view.ContainerViewPager;
import com.example.taotao.viewpagerfragtab.view.LazyViewpager;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.radio_projects:
                viewPager.setCurrentItem(TAB_PROJECTS, true);
                break;
            case R.id.radio_studys:
                viewPager.setCurrentItem(TAB_STUDYS, true);
                break;
            case R.id.radio_user_center:
                viewPager.setCurrentItem(TAB_USER_CENTER, true );
                break;
        }
    }
